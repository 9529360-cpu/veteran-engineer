export const TOOL_DEFINITIONS = Object.freeze([
  ...
  ['mission_status', 'Read current mission, task, validation, review, and candidate status.'],
  ['mission_advance', 'Advance the mission state machine through execution, validation, review, and candidate creation.'],
