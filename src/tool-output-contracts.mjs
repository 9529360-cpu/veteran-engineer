...
const TOOL_OUTPUT_CONTRACTS = Object.freeze({
  ...
  machine_inspect: openObject('Read-only Veteran Machine Bridge inspection result.', {
    ...
    repository: anyField('Repository identity and dirty-state projection for repo.status.'),
    observedAt: stringField('Observation timestamp for repo.status.', { minLength: null }),
  ...
  machine_act: openObject('Veteran Machine Bridge mutation/execution result.', {
    ...
    bytes: integerField('Bytes written.', 0, Number.MAX_SAFE_INTEGER),
