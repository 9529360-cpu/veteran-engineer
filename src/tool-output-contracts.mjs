...
const OUTPUT_EVIDENCE_ATTACHMENT = openObject('Durable evidence attachment metadata. Attachment bytes remain out of structuredContent and may be projected separately as MCP content.', {
...
const OUTPUT_EVIDENCE = openObject('Evidence metadata record.', {
  ...
  attachments: { type: 'array', items: OUTPUT_EVIDENCE_ATTACHMENT, description: 'Durable attachment metadata; binary data is not embedded here.' },
