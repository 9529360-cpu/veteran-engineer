...
const frontend = path.join(skillRoot, 'references', 'frontend-implementation-patterns.md');
...
test('engineering context router treats UI and product design as first-class frontend capability', async (t) => {
  ...
  assert.ok(paths.includes('references/frontend-visual-system-patterns.md'));
