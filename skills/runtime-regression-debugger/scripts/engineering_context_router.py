...
ROUTES = {
    ...
    "cache": ["references/data-consistency-migration-patterns.md", "references/performance-scale-patterns.md"],
    "rate-limit": ["references/api-backend-patterns.md", "references/performance-scale-patterns.md"],
