    ...
    if profile == "workspace":
        return {
            ...
            "releaseProvenance": {
                ...
                "policy": "Publish Workspace releases only from the workspace-install artifact generated by a refs/heads/main push for this exact revision after the trusted exact-head CI, Skill Engineering, and Cross-platform workflow identities all completed successfully; never publish pull-request artifacts, workflow-dispatch artifacts, generic profile artifacts, hand-built bundles, or directly edited Workspace releases."
            },
            "platformNotes": {
                "webCompatible": True,
                "actions": "skill-only",
